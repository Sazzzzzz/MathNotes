...
\begin{solution}
    \begin{enumerate}
        ...
        \item 不一致收敛.
            ...
            % TODO: What's the right format for proof by contradiction?
        ...
        \item 一致收敛.
            当\(x \in [1+\delta,+\infty)\), 可知\(f_n(x)\)逐点收敛到\(1\). %ChkTeX 9
            \[
                \lim_{n \to \infty} \left\lVert f_{n}(x) - 1 \right\rVert
                = \lim_{n \to \infty} \sup_{x \in [1+\delta,+\infty)} \left\vert %ChkTeX 9
                \frac{1}{1 + x^{n}} \right\vert
