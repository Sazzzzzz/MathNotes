...
\begin{align*}
    ...
    \left( 1+\frac{1}{x} \right)^{x} &\sim \e - \frac{\e}{2}x
\end{align*}

\begin{align*}
    \frac{1}{1 - x} &= 1 + x + x^{2} + \dots\\
    \frac{1}{x + s} &= \frac{1}{s}\left( 1 - \frac{x}{s} +
    \left( \frac{x}{s} \right)^{2} - \dots \right)
\end{align*}
...
\begin{align*}
    \sin \theta \cos \varphi & = \frac{1}{2}\left( \sin(\theta + \varphi) +
    \sin(\theta - \varphi) \right) \\
    \cos \theta \sin \varphi & = \frac{1}{2}\left( \sin(\theta + \varphi) -
    \sin(\theta - \varphi) \right) \\
    \sin \theta \sin \varphi & = \frac{1}{2}\left( \cos(\theta - \varphi) -
    \cos(\theta + \varphi) \right) \\
...
如果函数\(f(x, y)\)在矩形区域\(X \times Y\)上Lebesgue可积，则有
